...
- **License**: MIT
- **Proxy Pattern**: TransparentUpgradeableProxy for upgradeability
- **Gas Optimization**: Via IR compilation enabled
...
- ✅ **Token Operations**: Minting, burning, transfers, permits
...
- ✅ **Bridge Operations**: Cross-chain transfer simulations with mock LayerZero endpoint
- ✅ **Fork Testing**: Real network state testing capabilities
...
- **@layerzerolabs/oapp-evm-upgradeable**: ^0.1.2 - LayerZero OApp framework
- **@layerzerolabs/oft-evm**: ^3.2.1 - LayerZero OFT implementation
- **@layerzerolabs/oft-evm-upgradeable**: ^3.2.0 - Upgradeable OFT contracts
- **@openzeppelin/contracts-upgradeable**: ^5.4.0 - Upgradeable OpenZeppelin contracts
